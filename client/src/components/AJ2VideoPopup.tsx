...
interface AJ2VideoPopupProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function AJ2VideoPopup({ isOpen, onClose }: AJ2VideoPopupProps) {
  ...
  return (
    ...
    >
      <div
        ...
        data-testid="aj2-video-titlebar"
      >
        ...
        <div className="flex items-center gap-1">
          <Button
            ...
            data-testid="button-maximize-aj2"
          >
