...
import { X, ArrowRight, Terminal as TerminalIcon, Radio, Book, TrendingUp, Wifi, Gamepad2, Upload, Mic, MessageSquare, Server, Monitor } from 'lucide-react';
...
const helpMenuItems: HelpMenuItem[] = [
  ...
  // Archimedes Workshop (Multi-language IDE)
  {
    id: 'workshop',
    category: 'Tools',
    title: 'Archimedes Workshop',
    description: 'Multi-language IDE with AI assistance, code execution, and learning materials (Python, JS, C++, Rust, Go, etc.)',
    command: 'workshop',
    example: 'workshop',
    icon: <TerminalIcon size={16} />
  },
